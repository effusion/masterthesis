...
Migration von MySQL nach MongoDB notwendig durch die sehr kleine Datenmengen wegen der umstellung von Paymit nach Twint.
...
Stateless kein Sessionhandling nötig
