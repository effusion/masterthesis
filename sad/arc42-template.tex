...
\newglossaryentry{Toggles}
{
	name=Feature Toogles,
	description={Sind Schalter welche das ein und aussschalten von Software Funktionalität steuert. Wird meistens im Zusammenhang mit Coninuous Deploment verwendet.}
}
