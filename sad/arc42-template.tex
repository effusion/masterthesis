...
{
	name=NoSQL,
	description={\textbf{N}ot \textbf{o}nly \textbf{SQL} sind Datenbanken welche sich nicht mehr an die relationalen Prinzipien halten und dadurch alternative Speicherformen für Daten ermöglichen. Die bekanntesten Typen sind Key-Value, Spalten-Orientiert, Dokumente-Orientiert und Graphen. NoSQL Datenbank besitzen im Vergleich zu relationalen Datenbanken kein Schema.}
}
...
{
	name=PCI,
	description={PCI Security Standards Council ist eine Organisation welche sich um Sicherheit im Bereich der elektronischen Zahlungsmittel kümmert und entsprechende Richtlinien hat, welche eine Firma erfüllen muss um Kreditkarten Transaktionen verarbeiten zu dürfen. \url{https://www.pcisecuritystandards.org/pci_security/} }
}
