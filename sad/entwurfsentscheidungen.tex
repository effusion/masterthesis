...
Als alternative zu einer relationalen Datenbank, kann eine dokumentenbasierte wie zum Beispiel MongoDB\footnote{https://www.mongodb.com} verwendet werden. Die Datenbank gehöhrt zu Familie der NoSQL Speicher und ist deshalb Schemalos. Sie ist durch Ihre Natur mit Dokumenten zu Arbeite trotzdem stuckweit strukturiert. 
\newline
\newline
\textbf{Vorteile}
\begin{itemize}
