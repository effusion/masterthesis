...
\begin{longtable}{ | p{1.2cm} | p{3cm} | p{8cm} | p{2cm} | p{8cm} | }
		...
		BK-\arabic{bk} \stepcounter{bk} & Konfigurationsänderung & Massstab wie einfach es ist die Konfiguration der Applikation mit der Software zu ändern. & 5 & Nicht-funktionale Anforderung, dass gewissen Eigenschaften ohne einen neustart geändert werden könne.\\
		\bottomrule
\end{longtable}
