...
\begin{itemize}
	\item Gelb sind die Teile welche den Use Case der Applikation abbilden und es dem Benutzer ermöglichen sich für TWINT anzumelden. Dazu gehören der WebServer mit dem statischen Inhalt für die Webseite, der Onboarding Server mit der Spring Boot Applikation sowie die Workflow Engine.
