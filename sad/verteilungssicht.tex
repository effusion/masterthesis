...
\begin{itemize}
	\item Gelb sind die Teile welche den Use Case der Applikation abbilden und es dem Benutzer ermöglichen sich für Paymit anzumelden. Dazu gehören der WebServer mit dem statischen Inhalt für die WebPage, die \textcolor{red}{TODO Server/Backendapplikation?} sowie die Workflow Enginge.
	...
	\item Blau sind Teile welche für die Datenspeicherung verwendet werden. Es handelt sich dabei um ein Replica Set von MongoDB. m
    Mehr Informationen zur Persistenz finden sich im Kapitel \ref{persistenz}.
\end{itemize}
