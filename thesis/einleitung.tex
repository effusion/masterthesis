...
Die Applikation wurde basierend auf neuen \textcolor{red}{TODO neueren bräuchte einen Vergleich, neuer als was. Alternativ könnte man aktuell benutzen)} Technologien und Methoden entwickelt, welche es erlauben die Applikation schneller von der Entwicklung in die Produktion zu bringen. Im Vergleich zu den aktuell üblichen Releasezyklen von drei Monaten ist dies ein grosser Schritt vorwärts.

Obschon die Applikation mittlerweile innert Tagesfrist ausgerollt werden kann, soll mit der Anpassung der Architektur auf Continuous Deployment \footnote{Methode welche es der Entwicklung und dem Betrieb erlaubt eine Applikation automatisch nach jedem Codecommit neu auf den produktiven Systemen zu installieren.} noch einen Schritt weiter gegangen werden. Um dieses Ziel zu erreichen muss die Architektur der Applikation, mit dem Schwerpunkt Kommunikation zwischen der \textcolor{red} {TODO Komponenten/Service?}, angepasst werden. Des Weiteren sind gegebenenfalls Änderungen an Prozessen, wie zum Beispiel im Change Management, notwendig.
...
\begin{table}[H]
	...
	\begin{tabular}{ | p{3cm} | p{11cm} | }
		...
		Datenbank Software & \textcolor{red}{TODO hier geht es wohl um die Datenbankversion und nicht um die Applikationsversion. Ich würde in dem Fall nicht von automatisch sprechen, auch Patchversionen bedingen bei der Datenbank einen Reboot, zumindest bei Oracle}Die automatische Aktualisierung ist nicht Teil der Architektur. Obschon Patches meist automatisch eingespielt werden können ist bei Major Versionen dies meistens mit mehr Aufwand verbunden. \\
		\bottomrule
	\end{tabular}
\end{table}
